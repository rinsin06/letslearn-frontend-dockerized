    ...
    const handleLogin = async (e) => {
      ...
      try {
          ...
          if (response && response.status === 200) {
            ...
            Cookies.set('refreshToken',refreshToken,{ expires: 10, secure: true, sameSite: 'none', domain: '.shopifytech.xyz' })
            Cookies.set('token',token,{ expires: 10, secure: true, sameSite: 'none', domain: '.shopifytech.xyz' })
